...
stylesheet.href = "https://github.com/oxmc/paypaldonatebutton/blob/main/paypal.css?raw=true";
...
const PaypalDonateButton = {
    ...
    create: function (elmid, options) {
        ...
        donateBtnContent.innerHTML = `<p style="${imgstyle}"><img src="${paypallogob64}" width="45px" height="45px"/></p><p html="Donate to ${opts.username}" style="${btnstyle}">Donate to ${opts.username}</p>`;
        ...
        document.getElementById("donate_btn").appendChild(donate_btn);
        document.getElementById("donate_btn").appendChild(donate_form);
